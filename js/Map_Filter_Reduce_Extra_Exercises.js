...
//
// Create array of user objects based on the customers array of objects (each user object should just have name and age
// properties)
//
// Create an array of civil servant customers (teachers and police officers) containing the same properties as the objects
// on the customers objects
//
// Determine the average age of all the customers
//
// Create a function makeSuperPet() that takes in the pets array as input and returns a single pet object with the
//     following shape...
//
// {
...
//
// Create a function getFemaleFamilyMembers() that when given the family variable as an argument, returns an array of
// female family member names
//
// Create a function makeLongPetString() that when given the variable of pets, returns a string of all property values
// with dashes separating each property value
//
...
// Create a function that when given an object, returns the property values as an array of elements
//
// Create a function that when given three arguments: a min num, a max num, an array of nums will return the array
// of nums that are only between the min and max values, inclusive
//
// Create a function that when given an array of strings, returns an array of objects with properties for the given
// string value and the length of the string and the string without vowels (not including y)
//
// Given the following:
...
// Use .reduce to transform the array into an object where the object's keys are ids and the values are objects that' +
// ' represent each user
...
// Challenge:
// Define a function named allIndexesOf that takes in two arguments. The first argument should be the array to search
// and the second argument should be the value you want to search for. If the item does not exist in the provided
...
// Challenge:
// Define a function named removeAll(array, value) that takes in two arguments. The first argument should be an
// array and the second argument should be a value you wish to
